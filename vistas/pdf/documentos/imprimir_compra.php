...
while ($row = mysqli_fetch_array($sql)) {
    ...
    $precio_costo_f = formatear_moneda($simbolo_moneda, $precio_costo); //Formateo variables
    $precio_costo_r = str_replace(",", "", $precio_costo_f); //Reemplazo las comas
    $precio_total   = $precio_costo_r * $cantidad;
    $precio_total_f = formatear_moneda($simbolo_moneda, $precio_total); //Precio total formateado
...
?>
        ...
        <tr>
            ...
            <td style="widtd: 15%; text-align: right;"> <?php echo formatear_moneda($simbolo_moneda, 0); ?></td>
        </tr><tr>
