...
<page pageset='new' backtop='10mm' backbottom='10mm' backleft='20mm' backright='20mm' style="font-size: 14px; font-family: helvetica">
  ...
  <table style="width: 100%; border: solid 0px black;" cellspacing=0>
    <tr>
      ...
      <td style="text-align: center;    width: 34%;font-size: 14px; font-weight: bold">Reporte de Pagos a Proveedores</td>
...
?>
  ...
  <table class="table-bordered" style="width:100%;">
    <tr class="midnight-blue">
     ...
     <th style="width:20%;text-align:center">Pagos</th>
...
while ($row = mysqli_fetch_array($query)) {
    ...
    <tr>
      ...
      <td><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $row['monto_abono']); ?></td>
      <td><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $row['abono']); ?></td>
      <td><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $row['saldo_abono']); ?></td>
    </tr>
    <?php }?>
  </table>
  <br><br>
...
<table cellpadding='4' cellspacing='0' border='0'>
  <tr>
    ...
    <th style="width: 35%">Total Pagado</th>
    <th style="width: 35%">Saldo</th>
  </tr>
  <tr>
    <td style="height:5%;text-align: left"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $credito); ?></td>
    <td style="height:5%;text-align: left"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $total_abono); ?></td>
    <td style="height:5%;text-align: left"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $saldo); ?></td>
  </tr>
</table>
<br><br>
<br><br>
