		...
		<div class="modal fade" id="dataDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<p class="lead text-muted text-center" style="display: block;margin:9px">Esta acción anulara los totales de las facturas de forma permanente Deseas continuar?</p>
