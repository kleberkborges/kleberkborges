...
if (isset($_REQUEST['numero_factura'])) {
  ...
  <div class="alert alert-danger">
    <strong>¡Aviso!</strong> Realizar Cobro de la Factura Nº <strong><?php echo $numero_factura; ?></strong>
  </div>
    <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="abono" class="control-label">Pago:</label>
                  <input type="text" class="form-control" id="abono" name="abono" autocomplete="off" pattern="^[0-9]{1,}$" title="Ingresa un número" required autofocus>
                </div>
              </div>
            </div>
            <div class="row">
