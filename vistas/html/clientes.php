									...
									<div class="form-group row">
										<div class="col-md-6">
											<div class="input-group">
												<input type="text" class="form-control" id="q" placeholder="Buscar por Nombre o RUC/Cédula" onkeyup='load(1);' autocomplete="off">
											...
											<div class="col-md-2">
												<div class="btn-group pull-right">
													<button type="button" class="btn btn-success rounded waves-effect waves-light" data-toggle="modal" data-target="#nuevoCliente"><i class="fa fa-plus"></i> Agregar</button>
												</div>
...
<script>
    ...
    //VentanaCentrada('../excel/rep_gastos.php?daterange='+daterange+"&employee_id="+employee_id,'Reporte','','500','25','true');+"&tipo="+tipo
      ...
      <script type="text/javascript">
		...
		var q=$("#q").val();
		console.log(q);
		VentanaCentrada('../pdf2/rep_clientes.php','Reporte','','800','600','true');
	}
      </script>
