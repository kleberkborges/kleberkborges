          ...
          <div class="col-lg-12">
            ...
            <div class="portlet">
                <div class="portlet-heading bg-primary">
                    <h3 class="portlet-title">estados de servicio</h3>
...
?>
                        ...
                        <div class='outer_div_estados_servicios mt-2'></div><!-- Carga los datos ajax -->
...
<!-- ============================================================== -->
<script type="text/javascript" src="../../js/estados_servicios.js" async></script>
