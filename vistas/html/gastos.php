										...
										<div class="col-md-6">
											...
											<div class="col-md-3">
												<div class="btn-group pull-right">
													<button type="button" class="btn btn-success rounded waves-effect waves-light" data-toggle="modal" data-target="#nuevoGasto"><i class="fa fa-plus"></i> Agregar</button>
												</div>
...
?>
	...
	<script type="text/javascript" src="../../js/gastos.js" async></script>
