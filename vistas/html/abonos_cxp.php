														...
														<button class="btn btn-info waves-effect waves-light" type="button" onclick='load(1);'><i class='fa fa-search'></i></button>
															...
															<div class="col-xs-2">
																<div class="btn-group pull-center">
																	<?php if ($permisos_ver == 1) {?>
																	<button type="button" class="btn btn-success waves-effect waves-light" data-toggle="modal" data-target="#add-stock"><i class="fa fa-plus"></i> Pago</button>
																	<?php }?>
																</div>
															</div>
															<div class="col-xs-2">
...
<script type="text/javascript" src="../../js/ver_cxp.js" defer></script>
<script>
	$(document).ready( function () {
		formatear_moneda('abono');
...
<script>
	function reporte() {
		...
		var tipo = $("#tipo").val();
		VentanaCentrada('../pdf2/rep_cxp.php?daterange=' + daterange, 'Reporte', '', '800', '600', 'true');
	}
</script>
<script>
	function imprimir_abono(id_abono) {
		VentanaCentrada('../pdf2/rep_abono_prov.php?id_abono=' + id_abono, 'Reporte', '', '800', '600', 'true');
	}
</script>
