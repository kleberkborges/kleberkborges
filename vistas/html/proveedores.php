				...
				<div class="col-lg-12">
					<div class="portlet">
						<div class="portlet-heading bg-primary">
							<h3 class="portlet-title">proveedores</h3>
							<div class="portlet-widgets">
								<a href="javascript:;" data-toggle="reload"><i class="ion-refresh"></i></a>
								<span class="divider"></span>
								<a data-toggle="collapse" data-parent="#accordion2" href="#bg-secundary"><i class="ion-minus-round"></i></a>
								<span class="divider"></span>
								<a href="#" data-toggle="remove"><i class="ion-close-round"></i></a>
							</div>
							<div class="clearfix"></div>
						</div>
						<div id="bg-secundary" class="panel-collapse collapse show">
									...
									<div class="form-group row">
										<div class="col-md-6">
											<div class="input-group">
												<input type="text" class="form-control" id="q_proveedor" placeholder="Buscar por Nombre o RUC/Cédula" onkeyup='load_proveedores(1);' autocomplete="off">
...
?>
												<div class="btn-group dropup">
													...
													<div class="dropdown-menu">
														<a class="dropdown-item" href="#" onclick="reporte_proveedores();">
															<i class='fa fa-file-pdf-o'></i> PDF
														</a>
														<a class="dropdown-item" href="#" onclick="reporte_excel_proveedore();">
...
<?php }?>
								...
								<div class="datos_ajax_delete_proveedor"></div><!-- Datos ajax Final -->
								<div class='outer_div_proveedores'></div><!-- Carga los datos ajax -->
							</div>
						</div>
					</div>
				</div>
    ...
    //VentanaCentrada('../excel/rep_gastos.php?daterange='+daterange+"&employee_id="+employee_id,'Reporte','','500','25','true');+"&tipo="+tipo
       ...
       <script type="text/javascript">
      	function reporte_proveedores(){
			...
			VentanaCentrada('../pdf2/rep_proveedores.php?q='+q,'Reporte','','800','600','true');
		}
      </script>
