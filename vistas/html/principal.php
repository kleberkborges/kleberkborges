...
<!-- grafico -->
<script src="../../assets/js/plotly.js" defer></script>
          ...
          <div class="row">
            ...
            <a href="bitacora_compras.php">
              <div class="widget-bg-color-icon card-box">
                ...
                <div class="text-right">
                  <h5 class="text-dark text-center"><b class="counter text-pink"><?php total_egresos_dia();?></b></h5>
            ...
            <div class="col-lg-8">
              <div class="card-box">
                ...
                <div class="widget-chart text-center">
                  <div class='row'>
                    <div class='col-md-4'>
                      <select class="form-control" id="periodo" onchange="">
                        <?php
...
latest_order();
    ?>
              ...
              <div class="card-box widget-user">
                <div>
                  <img src="../../assets/images/users/user.png" class="rounded-circle" alt="user">
