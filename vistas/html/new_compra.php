												...
												<div class="widget-chart">
													<form role="form" id="datos_factura">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<div id="f_resultado">
																		<input type="text" class="form-control" autocomplete="off" id="factura" name="factura">
																	</div>
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<input type="date" class="form-control" id="fecha" name="fecha" required tabindex="4" style="font-size:14px">
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	<label for="fiscal">Formas de Pago</label>
																	<select class='form-control' id="condiciones" name="condiciones" onchange="showDiv(this)">
														...
														<div class="row" id="credito_display">
														</div>
														<div class="row">
															<div class="col-md-12">
																<div class="form-group">
																	<label for="ref">Observación</label>
																	<textarea class="form-control" cols="30" rows="2" maxlength="255" id="ref" name="ref" tabindex="0"></textarea>
																</div>
															</div>
														</div>
...
<script type="text/javascript" src="../../js/compra.js" async></script>
...
<script>
	function showDiv(select){
		if(select.value == 4){
			...
			$('#resultados2').load('../ajax/carga_cheque_compra.php');
			$("#credito_display").empty();
		} else if (select.value == 3) {
			$('#resultados2').load('../ajax/carga_tarjeta.php');
			$("#credito_display").empty();
		} else {
