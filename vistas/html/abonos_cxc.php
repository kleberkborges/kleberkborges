...
<script type="text/javascript" src="../../js/ver_cxc.js" defer></script>
...
<script>
	function reporte() {
		...
		var tipo = $("#tipo").val();
		VentanaCentrada('../pdf2/rep_cxc.php?daterange=' + daterange, 'Reporte', '', '800', '600', 'true');
	}
</script>
<script>
	function imprimir_abono(id_abono) {
		VentanaCentrada('../pdf2/rep_abono.php?id_abono=' + id_abono, 'Reporte', '', '800', '600', 'true');
	}
</script>
