...
while ($row = mysqli_fetch_array($query)) {
    ...
    <tr>
        <td><span class="badge badge-purple text-light"><?php echo $id_linea; ?></span></td>
        ...
        <td class="pull-right">
            ...
            if ($permisos_eliminar == 1) {?>
                   <a class="dropdown-item" href="#" data-toggle="modal" data-target="#dataDeleteCategoria" data-id="<?php echo $id_linea; ?>"><i class='fa fa-trash'></i> Borrar</a>
                   <?php }
            ?>
