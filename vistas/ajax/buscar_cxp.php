...
while ($row = mysqli_fetch_array($query)) {
            ...
            ?>
                        <tr>
                         <td><label class='badge badge-purple text-light'><?php echo $numero_factura; ?></label></td>
                         <td><?php echo $fecha; ?></td>
                         <td><?php echo $nombre_proveedor; ?></td>
                         <td><span class="badge <?php echo $label_class; ?>"><?php echo $text_estado; ?></span></td>
                         <td class='text-left'><b><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $total_venta); ?></b></td>
                         <td class='text-left'><b><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $saldo); ?></b></td>
                         <td class="text-center">
                          <div class="btn-group dropdown">
                            <button type="button" class="btn btn-warning btn-sm dropdown-toggle waves-effect waves-light" data-toggle="dropdown" aria-expanded="false"> <i class='fa fa-cog'></i> <i class="caret"></i> </button>
                            <div class="dropdown-menu dropdown-menu-right">
                               <?php if ($permisos_editar == 1) {?>
                               <a class="dropdown-item" href="abonos_cxp.php?numero_factura=<?php echo $numero_factura; ?>"><i class='fa fa-search'></i> Ver Pagos</a>
                               <?php }
