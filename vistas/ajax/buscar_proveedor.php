...
while ($row = mysqli_fetch_array($query)) {
            ...
            ?>
                    ...
                    <tr>
                    <td><span class="badge badge-purple text-light"><?php echo $id_proveedor; ?></span></td>
                        <td>
                    ...
                    <td >
                        <div class="btn-group dropdown pull-right">
                            <button type="button" class="btn btn-warning rounded btn-sm waves-effect waves-light" data-toggle="dropdown" aria-expanded="false"> <i class='fa fa-cog'></i> <i class="caret"></i> </button>
            ...
            if ($permisos_eliminar == 1) {?>
                             <a class="dropdown-item" href="#" data-toggle="modal" data-target="#dataDeleteProveedor" data-id="<?php echo $id_proveedor; ?>"><i class='fa fa-trash'></i> Borrar</a>
                             <?php }?>
