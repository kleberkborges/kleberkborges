...
?>
            <tr>
                ...
                <td class='text-center' width="10%"><?php echo $unidad_medida; ?></td>
                ...
                <td class='text-center'>
                    <a class='btn btn-success' href="#" title="Agregar a Factura" onclick="agregar('<?php echo $id_producto ?>')"><i class="fa fa-plus"></i></a>
                </td>
            </tr>
<?php
    }
