	...
	<div class="card-box widget-icon">
		<div>
			...
			<div class="wid-icon-info text-right">
				...
				<h4 class="m-t-0 m-b-5 counter font-bold text-primary"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $credito); ?></h4>
			</div>
		</div>
	</div>
</div>
<div class="col-lg-12 col-md-6">
	<div class="card-box widget-icon">
		<div>
			...
			<div class="wid-icon-info text-right">
				<p class="text-muted m-b-5 font-13 font-bold text-uppercase">TOTAL PAGADO</p>
				<h4 class="m-t-0 m-b-5 counter font-bold text-success"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $total_abono); ?></h4>
			</div>
		</div>
	</div>
</div>
	...
	<div class="card-box widget-icon">
		<div>
			...
			<div class="wid-icon-info text-right">
				...
				<h4 class="m-t-0 m-b-5 counter font-bold text-danger"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $saldo); ?></h4>
			</div>
		</div>
	</div>
</div>