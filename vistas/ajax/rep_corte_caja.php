        ...
        <div class="col-sm-6">
          <table class="table table-bordered" cellspacing="0" style="width: 100%;font-size: 12pt;">
            ...
            <tr>
             ...
             <td style="width:50%; text-align: left;"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $totalEfectivo); ?></td>
           </tr>
           <tr>
             <td style="width:50%;text-align: left;">Cheque:</td>
             <td style="width:50%; text-align: left;"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $totalCheque); ?></td>
           </tr>
           <tr>
             <td style="width:50%;text-align: left;">Tarjeta:</td>
             <td style="width:50%; text-align: left;"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $totalBanco); ?></td>
           </tr>
           <tr>
             <td style="width:50%;text-align: left;">Crédito:</td>
             <td style="width:50%; text-align: left;"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $totalCredito); ?></td>
           </tr>
           <tr>
             <td style="width:50%;text-align: right;font-weight:bold;">Total Ventas:</td>
             <td style="width:50%; text-align: left;"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $totalVentas); ?></td>
           </tr>
         </table>
       </div>
       <?php
$totalEntrada   = 0;
      ...
      <div class="col-sm-6">
       ...
       <tr>
         <td style="width:50%;text-align: left;">Entradas:</td>
         <td style="width:50%; text-align: left;"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $totalEntrada); ?></td>
       </tr>
       <tr>
         <td style="width:50%;text-align: left;">Salidas:</td>
         <td style="width:50%; text-align: left;"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $totalSalida); ?></td>
       </tr>
        <tr>
         <td style="width:50%;text-align: left;">Créditos:</td>
         <td style="width:50%; text-align: left;"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $total_abono); ?></td>
     </tr>
       <tr>
         <td style="width:50%;text-align: right;font-weight:bold;">Total Efectivo:</td>
         <td style="width:50%; text-align: left;"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $total_efectivo + $total_abono); ?></td>
       </tr>
     </table>
   </div>
   <br>
   <div class="col-sm-12">
     <table class="table table-striped" cellspacing="0" style="width: 100%;font-size: 14pt;">
       <tr class="danger">
         ...
         <td style="width:50%; text-align: left;"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $totalEfectivo + $total_abono); ?></td>
       </tr>
     </table>
   </div>
