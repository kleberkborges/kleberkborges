...
?>
			<td><span class="badge badge-purple text-light"><?php echo $id_producto; ?></span></td>
                    ...
                    <td><a href="#" class="stretched-link" onclick="get_historial('<?=$id_producto?>')"><?php echo $nombre_producto; ?></a></td>
...
?>
							<a href="#" class="dropdown-item" data-toggle="modal" data-target="#add-stock" onclick="obtener_id('<?=$id_producto?>');"><i class="fa fa-edit"></i> Agregar Stock</a>
							<a href="#" class="dropdown-item" data-toggle="modal" data-target="#remove-stock" onclick="obtener_id('<?=$id_producto?>');"><i class="fa fa-trash"></i> Eliminar Stock</a>
<?php 
			}
?>
