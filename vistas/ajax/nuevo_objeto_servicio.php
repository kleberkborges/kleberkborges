...
if (empty($_POST['nombre'])) {
    ...
    if ($query_check == true) {
        $errors[] = "Nombre de Objeto de servicio ya está en uso.";
    } else {
        // write new user's data into database

        $query = mysqli_query($conexion, "INSERT INTO objetos (nombre) VALUES ('$nombre')");

        if ($query) {
            $messages[] = "Objeto de servicio agregado correctamente.";
        } else {
