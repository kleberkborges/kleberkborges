...
$finales = 0;
        while ($row = mysqli_fetch_array($query)) {
            ...
            ?>
                    <tr>
                        <td class='text-center'><label class='badge badge-purple text-light'><?php echo $codigo_producto; ?></label></td>
                        <td><?php echo $nombre_producto; ?></td>
                        <td><span class="badge badge-success"><?php echo $cantidad; ?></span></td>
                        <td class='text-left'><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $costo_saldo); ?></td>
                        <td><b><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $total_costo); ?></b></td>
                        <td><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $descuento); ?></td>
                        <td><b><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $final_items); ?></b></td>
                        <td><b><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $utilidad); ?></b></td>
                    </tr>
                    <?php }?>
                </table>
            </div>
