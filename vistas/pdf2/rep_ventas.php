...
if (!empty($_REQUEST['estado_factura']) && isset($_REQUEST['estado_factura'])) {
...
if (!empty($_REQUEST['employee_id']) && isset($_REQUEST['employee_id'])) {
...
// get the HTML
ob_start();
include dirname(__FILE__) . '/res/rep_ventas_html.php';
