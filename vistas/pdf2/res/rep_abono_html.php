...
?>
  ...
  <table cellpadding='4' cellspacing='0' border='0'>
    ...
    <tr>
      ...
      <td style="height:3%;text-align: right"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $abono); ?></td>
    </tr>

    <tr>
      <td colspan="3" style="text-align: right;">SUBTOTAL <?php echo $simbolo_moneda; ?> </td>
      <td style="text-align: right;"> <?php echo formatear_moneda($simbolo_moneda, $abono); ?></td>
    </tr>
