...
//---------------------------------------------------------------------------------------
$abonoSql    = "SELECT * FROM creditos_abonos where fecha_abono between '$fecha_inicial' and '$fecha_final' AND id_users_abono = '$employee_id'";
...
<table cellspacing="0" style="width: 85%;">
     ...
     <tr>
      ...
      <tr>
         ...
         <td style="width:50%; text-align: left;"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $total_efectivo); ?></td>
     </tr>
</table>
<br>
<table cellspacing="0" style="width: 85%;">
