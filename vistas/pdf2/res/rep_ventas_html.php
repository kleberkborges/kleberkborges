...
?>
    <tr>
      <td style='text-align:right;border-top:3px solid #2c3e50;padding:4px;padding-top:4px;font-size:14px' colspan="5"><?php echo $simbolo_moneda . '' . formatear_moneda($simbolo_moneda, $sumador_total) ?></td>
    </tr>
  </table>
  <page_footer>
